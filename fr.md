...
Mes coordonnées de contact sont tout [en bas de cette page](#contactez-moi-) car sans avoir eu [un aperçu de mes compétences](#intégration), elles ne vous serviront pas.
Si vous préférez me contacter et discuter de vive voix, suivez [ce lien](#contactez-moi-) !
...
- **CSS** : Les préprocesseurs SASS et LESS pour améliorer la modularité et la maintenabilité du CSS. Principalement avec des collections de facilitateurs comme Bootstrap, Foundation, Compass, Neat, Bourbon, Semantic.gs, Lesshat, ... ;
